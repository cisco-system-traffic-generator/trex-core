...
The general purpose is to check *specific* WLC in local mode (it might not work with other WLCs):

* Throughput of data plane
* Scale of control plane
