...
* Download latest OFED 4.3.1 OFED tar for RedHat 7.4 distro. 

[IMPORTANT]
=====================================
The version must be *MLNX_OFED_LINUX-4.3.1* or higher (4.3.1)
=====================================
...
For CX-5, it is better to have the ConnectX-5 Ex version which run faster. part number is MCX556A-EDAT
