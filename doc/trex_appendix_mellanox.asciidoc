...
* CentOS 7.6 (This is the *only* verified distro)
...
[IMPORTANT]
=====================================
The version must be exactly *MLNX_OFED_LINUX-4.6.1* for CentOS 7.6, any other versions might not work
=====================================

[IMPORTANT]
=====================================
CentOS/RHEL 7.6 distro and MLNX_OFED_LINUX-4.6.1 is mandatory to get support from us.
...
| 2.57 and above    | *only* 4.6    | CentOS 7.6
|=================
...
----
 ...
 Warning: results might be inaccurate in Virtual machine
 +------+-----------+-----------+-----------+-----------+
