...
As mentioned, to preserve high speed traffic generation, TRex handles neighboring protocols in the pre-test phase.
...
*Plans for next phase*: Add support at the CPP server. +
