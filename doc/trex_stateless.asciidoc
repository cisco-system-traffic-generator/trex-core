...
* Software Mode
* Packets are handled by RX thread, 5 Mpps
...
* All of the TPG received packets are redirected from the Data Plane to the Rx thread based on some magic installed in TPG packets. This limits the rate to around 5 Mpps.
