...
WARNING: In case your request too much memory, the process of allocating it will take time. Yet, we will attempt 
...
[source, bash]
----
trex>start -f stl/tpg_1tag_stream.py -t --burst-size 10 --pps 5 --vlans 19
----
