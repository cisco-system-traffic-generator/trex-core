...
The traffic_config API has a set of arguments for specifying streams - in particular, the packet template, which field, and how to send it.
// clarify "which field"
...
[NOTE]
=====================================
 Possible future feature: Ability to disable/enable specific stream, load a new stream dynamically, and so on.
=====================================
