...
----
    def create_stream (self):
        ...
        vm.var(name='var1', min_value=ord('a'), max_value=ord('c'), size=1, step=1, op='inc', 
               next_var='var2')                                                     #<2>
        vm.write(fv_name='var1', pkt_offset=44)
        vm.var(name='var2', min_value=ord('a'), max_value=ord('b'), size=1, step=1, op='inc',
...
The payloads of the packets contain aa,ab,ac,ba,bb,bc.
