...
----
    ...
    try:
        ...
        for i in range(num_streams):
            ...
            tx_stats = c.get_tpg_tx_stats(port=tx_port, tpgid=i)             # <5>
            rx_stats = c.get_tpg_stats(port=rx_port, tpgid=i, min_tag=0,
                             max_tag=num_tags, max_sections=num_tags)[0]     # <6>

            tpgid_passed = verify_stream_stats(rx_stats, tx_stats, rx_port,  # <7>
