...
=== Bird
==== Overview
link:https://bird.network.cz/[Bird Internet Routing Daemon] is a project aimed to develop a fully functional dynamic IP routing daemon. We integrated it into TRex in order to exploit it's features together with TRex.
...
1. Make sure you have configured trex yaml file with "stack: linux_based" (see  link:trex_manual.html#stacks[Linux Stack]) 
2. Make sure you have configured DUT routing protocols.
3. Run TRex in "ONE_QUEUE" mode "--software -c 1" and bird flag "--bird-server".
4. Run python script: `scripts/automation/trex_control_plane/interactive/trex/examples/stl/add_bird_node.py`
...
[NOTE]
=====================================================================
PyBird Client will release & disconnect anyway when the object will be destroyed. 
=====================================================================

==== Tutorial: Simple bird node adding
*Goal*:: 
    Demonstrate adding a bird node with multiple variants.
