...
** Ability to control the L7 application with more commands, see link:trex_astf.html# _tutorial_l7_emulation_fin_ack_fin_ack[l7-emulation-example] and link:cp_astf_docs/api/profile_code.html#astfprogram-class[l7-program]
