...
* DPDK 17.02 
** Support ConnectX-5 (wasn't verified) 
** ixgbe SR-IOV works 
* Ability to add VLAN per direction
* Stateless packet capture - ability to capture port tx side  
* mlx5 dpdk driver is share object. Reduce image OFED dependency
