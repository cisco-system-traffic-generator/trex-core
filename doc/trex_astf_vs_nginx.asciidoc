...
image::images/nginx_results.png[title="TRex with 1 DP core vs Nginx 16 cores",align="center",width=800, link="images/nginx_results.png"]
 ...
 *** TRex is shutting down - cause: 'CTRL + C detected'
 All cores stopped !! 
----
<1>TRex server is 84% and Client is 54% (server has more cycles)
