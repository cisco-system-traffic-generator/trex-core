...
[source,bash]
----
[bash]>docker pull trexcisco/trex:2.36                                     #<1>
[bash]>docker run --rm -it --privileged --cap-add=ALL trexcisco/trex:2.36  #<2>
...
[NOTE] You will need to redirect the folowing  ports 4500/4501/4507 to use the external GUI
