...
[NOTE] 
=====================================
You will need to redirect the following  ports 4500/4501/4507 to use the external GUI 
...
In order to use TRex VM, there are several easy steps to follow:
  ...
  . Download and install Oracle VM Virtual Box Manager link:https://www.virtualbox.org/wiki/Downloads[(VB download link)]. + 
    During installation you will be asked to allow the installation of system devices component interactions. Allow it.
  . Download the latest TRex VM by link:https://trex-tgn.cisco.com/trex/T_Rex_162_VM_Fedora_21.ova[clicking on this link]. Notice that this is the
...
In that case, please refer to link:https://www.virtualbox.org/ticket/4130[this link] and follow the provided steps to overcome this issue.
====
...
IMPORTANT: When launching a TRex command, pay attention to make sure that you are using `sudo` prefix at the beginning of the command line. + and that you updated to latest v1.62 is very old version
...
See link:trex_manual.html#_obtaining_the_trex_package[Related manual] section
...
1. Download the latest version of TrexViewer application and install it using link:http://trex-tgn.cisco.com/trex/client_gui/setup.exe[this link].
...
ifdef::backend-docbook[]
image::images/trex_monitor_config.png[title="TRex viewer start screen",align="center",width=400,link="images/trex_monitor_config.png"]
endif::backend-docbook[]

ifdef::backend-xhtml11[]
image::images/trex_monitor_config.png[title="TRex viewer start screen",align="center",width=900,link="images/trex_monitor_config.png"]
endif::backend-xhtml11[]
...
ifdef::backend-docbook[]
image::images/trex_monitor_view.png[title="TRex viewer monitor screen",align="center",width=400,link="images/trex_monitor_view.png"]
endif::backend-docbook[]

ifdef::backend-xhtml11[]
image::images/trex_monitor_view.png[title="TRex viewer monitor screen",align="center",width=900,link="images/trex_monitor_view.png"]
endif::backend-xhtml11[]
...
TRex identifies only the packets which were delicately sent by one of those traffic ports and receives them on the other port. Hence, packets generated by client port will be received by the server port and vice versa.
