...
* CentOS 7.4 (This is the only tested distro)
...
hash_from_mellanox  MLNX_OFED_LINUX-4.2-1-.0.0.0-rhel7.4-x86_64.tgz
----
...
==== How to upgrade from older TRex <v2.32


TRex v2.32 and lower works with OFED 4.1 and it can't work with new OFED 4.2 
...
| 2.33 or higer |  *only* 4.2  | CentOs 7.4
|=================
...
[options="header",cols="1^,1^,1^",width="60%"]
|=================
| Packet size  | Tx L1 Precent (100Gb) | Rx L1 Precent (with new FW) (100Gb)
| 64  |  100%  | 94%
| 128 |  100%  | 100%
| 256 |  90%   | 90%      
| 512 |  100%  | 100%
...
* a special FW to drop and count packets in high rate
