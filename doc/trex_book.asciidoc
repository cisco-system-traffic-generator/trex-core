...
NIC with two ports will work better from performance prospective, so it is better to have MCX455A-ECAT(two 100gb port) and *not* the  MCX456A-ECAT (one 100gb port).
