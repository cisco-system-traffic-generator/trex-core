...
87:00.0 Ethernet controller: Mellanox Technologies MT27700 Family [ConnectX-4]
        ...
        Capabilities: [48] Vital Product Data
                ...
                Read-only fields:
                        ...
                        [V0] Vendor specific: PCIeGen3 x16                             #<4>
...
80:03.0 PCI bridge: Intel Corporation Xeon E7 v3/Xeon E5 v3/Core i7 PCI Express Root Port 3 (rev 02) (prog-if 00 [Normal decode])
        ...
        Capabilities: [90] Express (v2) Root Port (Slot-), MSI 00
                ...
                LnkCtl: ASPM Disabled; RCB 64 bytes Disabled- CommClk+
                        ExtSynch- ClockPM- AutWidDis- BWInt- AutBWInt-
                LnkSta: Speed 8GT/s, Width x16, TrErr- Train- SlotClk+ DLActive+ BWMgmt+ ABWMgmt-       #<7>
...
<4>  PCI should be x16 in case it is not you should look for UCS PCIe configucation (raiser)
<5>  Check parent PCI speed --> in this case it is 0000:80:03.0
<6>  Look for the speed
<7>  The speed should be x16
