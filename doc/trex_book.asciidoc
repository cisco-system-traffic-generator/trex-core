...
* Download latest OFED 4.2.1 OFED tar for RedHat 7.4 distro. 

[IMPORTANT]
=====================================
The version must be *MLNX_OFED_LINUX-4.2.1* or higher (4.2.1)
=====================================
...
[source,bash]
----
[bash]>md5sum md5sum MLNX_OFED_LINUX-4.2-1.0.0.0-rhel7.4-x86_64.tgz
...
[source,bash]
----
[bash]>tar -xvzf MLNX_OFED_LINUX-4.2-1.0.0.0-rhel7.4-x86_64.tgz
[bash]>cd MLNX_OFED_LINUX-4.2-1.0.0.0-rhel7.4-x86_64.tgz
----
...
Starting MLNX_OFED_LINUX-4.2-1.0.0.0 installation ...

Installing mlnx-ofa_kernel RPM
Preparing...                          ########################################
Updating / installing...
mlnx-ofa_kernel-4.2-OFED.4.2.1.0.0.1.g########################################
Installing kmod-mlnx-ofa_kernel 4.2 RPM
Preparing...                          ########################################
kmod-mlnx-ofa_kernel-4.2-OFED.4.2.1.0.########################################
Installing mlnx-ofa_kernel-devel RPM
Preparing...                          ########################################
Updating / installing...
mlnx-ofa_kernel-devel-4.2-OFED.4.2.1.0########################################
Installing user level RPMs:
Preparing...                          ########################################
mstflint-4.8.0-1.4.g501cec1.42100     ########################################
Preparing...                          ########################################
ofed-scripts-4.2-OFED.4.2.1.0.0       ########################################
Preparing...                          ########################################
rdma-core-42mlnx2-1.42100             ########################################
Preparing...                          ########################################
libibumad-42mlnx2-1.42100             ########################################
Preparing...                          ########################################
libibmad-1.3.13.MLNX20170511.267a441-0########################################
Preparing...                          ########################################
mft-4.8.0-26                          ########################################
Preparing...                          ########################################
libibverbs-42mlnx2-1.42100            ########################################
Preparing...                          ########################################
rdma-core-devel-42mlnx2-1.42100       ########################################
Preparing...                          ########################################
libibverbs-utils-42mlnx2-1.42100      ########################################
Preparing...                          ########################################
librdmacm-42mlnx2-1.42100             ########################################
Preparing...                          ########################################
librdmacm-utils-42mlnx2-1.42100       ########################################
Device (87:00.0):
...
to upgrade the FW you need to try to download the tool and build for you system link:http://www.mellanox.com/page/management_tools[management_tools]

.upgrade FW for CX-5 device to support full-line rate with DROP
[source,bash]
----
$sudo mst start
$sudo mst status
...
For some reason the mlx5 driver is special and while working, integrating and running regression 24/7 we found  a few issues with how TRex utilized it. TRex uses special RSS configurations and filters and this might bring up the issues that otherwise were not observed (e.g. Simple DPDK l3 application). The list of the issues can be seen here link:https://trex-tgn.cisco.com/youtrack/issues/trex?q=%23MLX%20state:Submitted%20[open issues]
Mellanox is aware of those issues.

for example:
* In ASTF mode there is an out of order of TCP packets see link:https://trex-tgn.cisco.com/youtrack/issue/trex-481[out-of-order]
...
1. CX-5 can reach TX=~145MPPS/Rx=120MPPS while XL710 is limited to 35MPPS. (With potential future fix it will be ~65MPPS)
2. with IMIX you should reach ~100Gb/sec (not 100Gb/sec) with one port (Total bandwidth for both ports is 100Gb/Sec)
