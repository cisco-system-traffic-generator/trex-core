...
* It is not stateless IXIA/Ostinato/pktgen-dpdk like traffic generator. it has minimal stateless support
* There is emulation support for example BGP/ISIS/ARP 
* There is no TCP stack in this version
...
=== Wiki
 ...
 Internal https://github.com/cisco-system-traffic-generator/trex-core/wiki [Wiki] 
