...
NetflowV9TemplateFieldDecoders = {  # Only contains fields that have a fixed length
        ...
        21: (IntField, [True]),  # LAST_SWITCHED
        22: (IntField, [True]),  # FIRST_SWITCHED
...
class NetflowTemplateFlowsetV9(Packet):
    name = "Netflow Template FlowSet V9"
    fields_desc = [ FieldLenField("length", None, length_of="templates", adjust=lambda pkt,x:x+4),
...
class NetflowDataflowsetV9(Packet):
    ...
    fields_desc = [ FieldLenField("length", None, length_of="records", adjust = lambda pkt,x:x+4),
        ...
        for p in packet_list:
            if NetflowFlowsetV9 in p: ## STEP 1 - NetflowFlowsetV9
                ...
                for ntv9 in current.templates:
                    layer = root
                    while layer:
                        if hasattr(layer,'flowSetID') and layer.flowSetID==ntv9.templateID:
                            break
                        else:
                            if layer.payload:
                    ...
                    current_ftl=layer
                    if current_ftl:
                        current_ftl.getlayer(NetflowDataflowsetV9)
                        # Matched
                        try:
...
class NetflowOptionsFlowsetV9(Packet):
    ...
    fields_desc = [ LenField("length", None),
...
bind_layers( NetflowFlowsetV9, NetflowOptionsFlowsetV9, flowSetID=1 )
bind_layers( NetflowFlowsetV9, NetflowTemplateFlowsetV9, flowSetID=0 )
bind_layers( NetflowFlowsetV9, NetflowDataflowsetV9 )
bind_layers( NetflowTemplateFlowsetV9, NetflowFlowsetV9 )
bind_layers( NetflowOptionsFlowsetV9, NetflowFlowsetV9 )
bind_layers( NetflowDataflowsetV9, NetflowFlowsetV9 )## Netflow V5 appended by spaceB0x and Guillaume Valadon
## Netflow V9 appended ny Gabriel Potter
...
bind_layers( NetflowTemplateFlowsetV9, NetflowFlowsetV9 )
bind_layers( NetflowOptionsFlowsetV9, NetflowFlowsetV9 )
bind_layers( NetflowDataflowsetV9, NetflowFlowsetV9 )