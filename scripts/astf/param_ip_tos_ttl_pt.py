...
# per template ip.tos/ip.ttl ipv6/ipv4
#
# 
...
class Prof1():
    ...
    def get_profile(self, tunables, **kwargs):
        ...
        c_info.ip.tos = 0x80
        c_info.ip.ttl = 100
        c_info.ipv6.src_msb ="ff02::"
        c_info.ipv6.dst_msb ="ff03::"
        c_info.ipv6.enable  =1

        c_info_udp = ASTFGlobalInfoPerTemplate()
        c_info_udp.ip.tos = 0x82
        c_info_udp.ip.ttl = 100
        c_info_udp.ipv6.src_msb ="ff02::"
        c_info_udp.ipv6.dst_msb ="ff03::"
        c_info_udp.ipv6.enable  =1


        s_info = ASTFGlobalInfoPerTemplate()
        s_info.ip.tos = 0x83
        s_info.ip.ttl = 41
        s_info.ipv6.src_msb ="ff02::"
        s_info.ipv6.dst_msb ="ff03::"
        s_info.ipv6.enable  =1

        s_info_udp = ASTFGlobalInfoPerTemplate()
        s_info_udp.ip.tos = 0x84
        s_info_udp.ip.ttl = 42
        s_info_udp.ipv6.src_msb ="ff02::"
        s_info_udp.ipv6.dst_msb ="ff03::"
        s_info_udp.ipv6.enable  =1
