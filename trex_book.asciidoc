...
[IMPORTANT]
=====================================
* For VMXNET3 use Ubuntu and *not* Fedora.
...
Username/password: trex/trex. Root password is trex as well. +
It has TRex v1.83 in /home/trex directory + 2xVMXNET3 NICs for TRex + /etc/trex_cfg.yaml configured for them. Ready to run.
