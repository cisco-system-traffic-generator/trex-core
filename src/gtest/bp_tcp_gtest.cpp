...
double fixedToFloat_0_32( u32 val ) { return (((double)val) / U32_MAX ); }
u32    floatToFixed_0_32( double val ) { return (u32)( val * U32_MAX ); }
...
static void norm_prob(std::vector<double> prob,
...
static void dump_prob(std::vector<double> prob){
...
/* policer random */
 ...
 public:
    ...
    virtual CPolicerNuRand(const std::vector<double> prob);
