...
public:
    ...
    void stop_traffic(stream_ids_t &stream_ids);
...
public:
     ...
     * 
     */
    void push_remote(string profile_id,
    ...
    bool is_running_flow_stats(string profile_id);
     ...
     *
     */
    //int get_max_stream_id(string profile_id) const;
    int get_max_stream_id(string profile_id);
    int get_max_stream_id();


    /**
     * remove and delete all profiles including streams
     *
     */
    void remove_and_delete_all_streams();
    ...
    string all_profiles = "all_profiles";
