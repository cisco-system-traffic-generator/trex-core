...
bool CRxCounters::Create(){
    ...
    RX_S_ADD_CNT(m_gen_cnt[CNT_TX][CNT_PKT][CNT_BROADCAST],"tx_broadcast_pkts","tx _broadcast pkts");
//
    ...
    RX_S_ADD_CNT(m_gen_cnt[CNT_TX][CNT_BYTE][CNT_BROADCAST],"tx_broadcast_bytes","tx _broadcast bytes");
