#ifndef TREX_DRIVERS_IGC_H
#define TREX_DRIVERS_IGC_H
...
class CTRexExtendedDriverBase2500M : public CTRexExtendedDriverBase {

public:
    CTRexExtendedDriverBase2500M();

    static CTRexExtendedDriverBase * create(){
        return ( new CTRexExtendedDriverBase2500M() );
    }
