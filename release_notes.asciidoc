...
* Support IPV6 latency streams (support is available for all interface types except 82599) see link:https://trex-tgn.cisco.com/trex/doc/trex_stateless.html#_tutorial_per_stream_latency_jitter_packet_errors
