...
comment_link_to_results() {
    ...
    curl -H "Authorization: token $GITHUB_COMMENT_TOKEN" -X POST -d "{\"body\": \"$COMMENT\"}" "https://api.github.com/repos/elados93/trex-core/issues/$TRAVIS_PULL_REQUEST/comments"
